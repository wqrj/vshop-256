...
public class Factory {
	private final static MessageUtil DAO_MESSAGE = new MessageUtil("cn.mldn.util.message.service.dao") ;
	private final static MessageUtil SERVICE_MESSAGE = new MessageUtil("cn.mldn.util.message.service.service") ;
